...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> MemberNotFoundException(InvalidDateException iexp, WebRequest req) {

		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), iexp.getMessage(), req.getDescription(false));
	...
	public ResponseEntity<MyErrorDetails> MemberNotFoundException(DuplicateEntryException dexp, WebRequest req) {

		MyErrorDetails err = new MyErrorDetails(LocalDateTime.now(), dexp.getMessage(), req.getDescription(false));
